 ...
 * {@link com.liferay.portlet.asset.service.impl.AssetEntryViewStatsLocalServiceImpl} and is the
...
public class AssetEntryViewStatsLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.portlet.asset.service.impl.AssetEntryViewStatsLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.asset.kernel.model.AssetEntryViewStats addAssetEntryViewStats(
		com.liferay.asset.kernel.model.AssetEntryViewStats assetEntryViewStats) {
	...
	*/
	public static com.liferay.asset.kernel.model.AssetEntryViewStats createAssetEntryViewStats(
		long statsId) {
	...
	*/
	public static com.liferay.asset.kernel.model.AssetEntryViewStats deleteAssetEntryViewStats(
		com.liferay.asset.kernel.model.AssetEntryViewStats assetEntryViewStats) {
	...
	*/
	...
	public static com.liferay.asset.kernel.model.AssetEntryViewStats fetchAssetEntryViewStats(
		long statsId) {
	...
	* @throws PortalException if a asset entry view stats with the primary key could not be found
	*/
	public static com.liferay.asset.kernel.model.AssetEntryViewStats getAssetEntryViewStats(
		long statsId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static com.liferay.asset.kernel.model.AssetEntryViewStats updateAssetEntryViewStats(
		com.liferay.asset.kernel.model.AssetEntryViewStats assetEntryViewStats) {
	...
	*/
	public static java.util.List<com.liferay.asset.kernel.model.AssetEntryViewStats> getAssetEntryViewStatses(
		int start, int end) {
		return getService().getAssetEntryViewStatses(start, end);
	}

	public static java.util.List<com.liferay.asset.kernel.model.AssetEntryViewStatsResult> getViewCounts(
		java.lang.String className, long classPK, int type) {
		return getService().getViewCounts(className, classPK, type);
	}

	public static java.util.List<com.liferay.asset.kernel.model.AssetEntryViewStats> getViewsBetweenDates(
		java.lang.String className, long classPK, java.util.Date startDate,
		java.util.Date endDate) {
		return getService()
				   .getViewsBetweenDates(className, classPK, startDate, endDate);
	}
	...
	*/
	...
	public static long getViewCountBetweenDates(java.lang.String className,
		long classPK, java.util.Date startDate, java.util.Date endDate) {
		return getService()
				   .getViewCountBetweenDates(className, classPK, startDate,
			endDate);
	}

	public static AssetEntryViewStatsLocalService getService() {
		if (_service == null) {
			_service = (AssetEntryViewStatsLocalService)PortalBeanLocatorUtil.locate(AssetEntryViewStatsLocalService.class.getName());

			ReferenceRegistry.registerReference(AssetEntryViewStatsLocalServiceUtil.class,
				"_service");
		}
	...
	private static AssetEntryViewStatsLocalService _service;
}