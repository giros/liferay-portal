...
public class LayoutCTPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(
			existingLayoutCT.getClassPK(), newLayoutCT.getClassPK());
		Assert.assertEquals(
	...
	public void testDynamicQueryByPrimaryKeyExisting() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq("id.classPK", newLayoutCT.getClassPK()));
		dynamicQuery.add(
	...
	public void testDynamicQueryByProjectionExisting() throws Exception {
		...
		Object newClassPK = newLayoutCT.getClassPK();
