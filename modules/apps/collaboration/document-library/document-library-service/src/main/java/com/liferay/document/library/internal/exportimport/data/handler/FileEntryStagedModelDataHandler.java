...
public class FileEntryStagedModelDataHandler
	...
	protected void doExportStagedModel(
		...
		larFile.endWriteStagedModel(fileEntry);
	}
	...
	protected void exportDDMFormValues(
		...
		larFile.startWriteCustom("structure-fields");

		String ddmFormValuesPath = ExportImportPathUtil.getModelPath(
			ddmStructure,
			String.valueOf(dlFileEntryMetadata.getDDMStorageId()));

		larFile.writeCustomAttribute(
			"structure-fields", "ddm-form-values-path", ddmFormValuesPath);

		larFile.writeCustomAttribute(
			"structure-fields", "structure-uuid", ddmStructure.getUuid());

		larFile.endWriteCustom("structure-fields");
