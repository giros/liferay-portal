...
package com.liferay.asset.entry.view.stats.service.persistence.impl;

import aQute.bnd.annotation.ProviderType;

import com.liferay.asset.entry.view.stats.exception.NoSuchAssetEntryViewStatsException;
import com.liferay.asset.entry.view.stats.model.AssetEntryViewStats;
import com.liferay.asset.entry.view.stats.model.impl.AssetEntryViewStatsImpl;
import com.liferay.asset.entry.view.stats.model.impl.AssetEntryViewStatsModelImpl;
 ...
 * @see com.liferay.asset.entry.view.stats.service.persistence.AssetEntryViewStatsUtil
 * @generated
 */
@ProviderType
public class AssetEntryViewStatsPersistenceImpl extends BasePersistenceImpl<AssetEntryViewStats>
	...
	public AssetEntryViewStats findByC_C_First(long classNameId, long classPK,
		OrderByComparator<AssetEntryViewStats> orderByComparator)
		throws NoSuchAssetEntryViewStatsException {
		...
		throw new NoSuchAssetEntryViewStatsException(msg.toString());
	}
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C_LTD = new FinderPath(AssetEntryViewStatsModelImpl.ENTITY_CACHE_ENABLED,
			AssetEntryViewStatsModelImpl.FINDER_CACHE_ENABLED,
			AssetEntryViewStatsImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_C_LtD",
			new String[] {
				Long.class.getName(), Long.class.getName(), Date.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_C_LTD = new FinderPath(AssetEntryViewStatsModelImpl.ENTITY_CACHE_ENABLED,
			AssetEntryViewStatsModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByC_C_LtD",
			new String[] {
				Long.class.getName(), Long.class.getName(), Date.class.getName()
			});
	 ...
	 */
	@Override
	public List<AssetEntryViewStats> findByC_C_LtD(long classNameId,
		long classPK, Date createDate) {
		return findByC_C_LtD(classNameId, classPK, createDate,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<AssetEntryViewStats> findByC_C_LtD(long classNameId,
		long classPK, Date createDate, int start, int end) {
		return findByC_C_LtD(classNameId, classPK, createDate, start, end, null);
	}
	...
	public List<AssetEntryViewStats> findByC_C_LtD(long classNameId,
		long classPK, Date createDate, int start, int end,
		OrderByComparator<AssetEntryViewStats> orderByComparator) {
		return findByC_C_LtD(classNameId, classPK, createDate, start, end,
			orderByComparator, true);
	}
	...
	public List<AssetEntryViewStats> findByC_C_LtD(long classNameId,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C_LTD;
		finderArgs = new Object[] {
				classNameId, classPK, createDate,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_C_LTD_CLASSNAMEID_2);

			query.append(_FINDER_COLUMN_C_C_LTD_CLASSPK_2);

			boolean bindCreateDate = false;

			if (createDate == null) {
				query.append(_FINDER_COLUMN_C_C_LTD_CREATEDATE_1);
			}
			else {
				bindCreateDate = true;

				query.append(_FINDER_COLUMN_C_C_LTD_CREATEDATE_2);
			}
	 ...
	 */
	@Override
	public AssetEntryViewStats findByC_C_LtD_First(long classNameId,
		long classPK, Date createDate,
		OrderByComparator<AssetEntryViewStats> orderByComparator)
		throws NoSuchAssetEntryViewStatsException {
		AssetEntryViewStats assetEntryViewStats = fetchByC_C_LtD_First(classNameId,
				classPK, createDate, orderByComparator);
	 ...
	 */
	@Override
	public AssetEntryViewStats fetchByC_C_LtD_First(long classNameId,
		long classPK, Date createDate,
		OrderByComparator<AssetEntryViewStats> orderByComparator) {
		List<AssetEntryViewStats> list = findByC_C_LtD(classNameId, classPK,
				createDate, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public AssetEntryViewStats findByC_C_LtD_Last(long classNameId,
		long classPK, Date createDate,
		OrderByComparator<AssetEntryViewStats> orderByComparator)
		throws NoSuchAssetEntryViewStatsException {
		AssetEntryViewStats assetEntryViewStats = fetchByC_C_LtD_Last(classNameId,
				classPK, createDate, orderByComparator);
	 ...
	 */
	@Override
	public AssetEntryViewStats fetchByC_C_LtD_Last(long classNameId,
		long classPK, Date createDate,
		OrderByComparator<AssetEntryViewStats> orderByComparator) {
		int count = countByC_C_LtD(classNameId, classPK, createDate);
	 ...
	 */
	@Override
	public AssetEntryViewStats[] findByC_C_LtD_PrevAndNext(long statsId,
		long classNameId, long classPK, Date createDate,
		OrderByComparator<AssetEntryViewStats> orderByComparator)
		throws NoSuchAssetEntryViewStatsException {
		AssetEntryViewStats assetEntryViewStats = findByPrimaryKey(statsId);
		...
		try {
			...
			array[0] = getByC_C_LtD_PrevAndNext(session, assetEntryViewStats,
					classNameId, classPK, createDate, orderByComparator, true);

			array[1] = assetEntryViewStats;

			array[2] = getByC_C_LtD_PrevAndNext(session, assetEntryViewStats,
					classNameId, classPK, createDate, orderByComparator, false);
	...
	protected AssetEntryViewStats getByC_C_LtD_PrevAndNext(Session session,
		AssetEntryViewStats assetEntryViewStats, long classNameId,
		long classPK, Date createDate,
		OrderByComparator<AssetEntryViewStats> orderByComparator,
		boolean previous) {
	 ...
	 */
	@Override
	public void removeByC_C_LtD(long classNameId, long classPK, Date createDate) {
		for (AssetEntryViewStats assetEntryViewStats : findByC_C_LtD(
				classNameId, classPK, createDate, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(assetEntryViewStats);
		}
	 ...
	 */
	@Override
	public int countByC_C_LtD(long classNameId, long classPK, Date createDate) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_C_LTD;
	...
	private static final String _FINDER_COLUMN_C_C_LTD_CLASSNAMEID_2 = "assetEntryViewStats.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_C_LTD_CLASSPK_2 = "assetEntryViewStats.classPK = ? AND ";
	private static final String _FINDER_COLUMN_C_C_LTD_CREATEDATE_1 = "assetEntryViewStats.createDate IS NULL";
	private static final String _FINDER_COLUMN_C_C_LTD_CREATEDATE_2 = "assetEntryViewStats.createDate < ?";
	...
	public AssetEntryViewStats remove(Serializable primaryKey)
		...
		try {
			...
			if (assetEntryViewStats == null) {
				...
				throw new NoSuchAssetEntryViewStatsException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}

			return remove(assetEntryViewStats);
		}
		catch (NoSuchAssetEntryViewStatsException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	public AssetEntryViewStats updateImpl(
		...
		if (isNew || !AssetEntryViewStatsModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
