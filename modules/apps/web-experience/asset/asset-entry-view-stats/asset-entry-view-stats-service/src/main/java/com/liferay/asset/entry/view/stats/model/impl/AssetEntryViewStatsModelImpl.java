...
import com.liferay.asset.entry.view.stats.model.AssetEntryViewStatsModel;
import com.liferay.asset.entry.view.stats.model.AssetEntryViewStatsSoap;
...
public class AssetEntryViewStatsModelImpl extends BaseModelImpl<AssetEntryViewStats>
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.asset.entry.view.stats.service.util.PropsUtil.get(
				"value.object.entity.cache.enabled.com.liferay.asset.entry.view.stats.model.AssetEntryViewStats"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.asset.entry.view.stats.service.util.PropsUtil.get(
				"value.object.finder.cache.enabled.com.liferay.asset.entry.view.stats.model.AssetEntryViewStats"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.asset.entry.view.stats.service.util.PropsUtil.get(
				"value.object.column.bitmask.enabled.com.liferay.asset.entry.view.stats.model.AssetEntryViewStats"),
			true);
	 ...
	 */
	public static AssetEntryViewStats toModel(AssetEntryViewStatsSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		AssetEntryViewStats model = new AssetEntryViewStatsImpl();
	 ...
	 */
	public static List<AssetEntryViewStats> toModels(
		AssetEntryViewStatsSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<AssetEntryViewStats> models = new ArrayList<AssetEntryViewStats>(soapModels.length);

		for (AssetEntryViewStatsSoap soapModel : soapModels) {
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.asset.entry.view.stats.service.util.PropsUtil.get(
				"lock.expiration.time.com.liferay.asset.entry.view.stats.model.AssetEntryViewStats"));
