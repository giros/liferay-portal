...
public interface CTEntryPersistence extends BasePersistence<CTEntry> {
	 ...
	 * @return the matching ct entries
	 */
	public java.util.List<CTEntry> findByC_S(long ctCollectionId, int status);
	 ...
	 * @return the matching ct entries
	 */
	public java.util.List<CTEntry> findByMCNI_MCPK(
	 ...
	 * @return the matching ct entries
	 */
	public java.util.List<CTEntry> findByCompanyId_MCNI_MCPK(
