		...
		>
			...
			<liferay-ui:search-container-column-text>
				...
				>
					...
					<liferay-portlet:actionURL name="/change_lists/checkout" var="checkoutCollectionURL">
						<portlet:param name="ctCollectionId" value="<%= String.valueOf(curCTCollection.getCtCollectionId()) %>" />
					...
					<liferay-portlet:actionURL name="/change_lists/publish" var="publishCollectionURL">
						<portlet:param name="ctCollectionId" value="<%= String.valueOf(curCTCollection.getCtCollectionId()) %>" />
					</liferay-portlet:actionURL>
